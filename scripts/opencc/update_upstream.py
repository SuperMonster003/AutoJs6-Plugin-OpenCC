#!/usr/bin/env python3
"""Prepare an exact OpenCC upstream upgrade pull request in a clean checkout."""
...
- [ ] Validate the upstream source and license changes; update `THIRD_PARTY_NOTICES.md` if needed.
- [ ] Validate every changed or failed conversion fixture individually. Never blanket-accept dictionary output drift.
